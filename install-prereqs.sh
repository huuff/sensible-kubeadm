...
curl "https://github.com/opencontainers/runc/releases/download/v$runc_version/runc.amd64"
install -m 755 runc.amd64 /usr/local/sbin/runc

echo "INSTALLING CNI PLUGINS"
curl "https://github.com/containernetworking/plugins/releases/download/v1.1.1/cni-plugins-linux-amd64-v$cni_plugins_version.tgz"
